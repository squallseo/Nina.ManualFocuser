...
namespace Cwseo.NINA.Focuser.FocuserDrivers {
    ...
    public class FocuserWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public FocuserWeatherProvider(IProfileService profileService) {
        ...
        public IList<IWeatherData> GetEquipment() {
            ...
            devices.Add(new FocuserWeatherDriver("MyUniqueId", "MyDeviceId"));

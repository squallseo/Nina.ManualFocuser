...
namespace Cwseo.NINA.Focuser.FocuserDrivers {
    /// <summary>
    ...
    /// </summary>
    public class FocuserWeatherDriver : BaseINPC, IWeatherData {
        public FocuserWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Focuser Weather Data ({deviceId})";
        ...
        public string Category => "Focuser Weather Driver";

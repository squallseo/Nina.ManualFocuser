...
namespace Cwseo.NINA.Focuser.FocuserTestCategory {
    ...
    public class FocuserCondition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(FocuserCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}
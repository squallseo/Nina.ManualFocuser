...
namespace Cwseo.NINA.Focuser.FocuserTestCategory {
    /// <summary>
    ...
    public class FocuserInstruction : SequenceItem {
        /// <summary>
        ...
        public FocuserInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public FocuserInstruction(FocuserInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new FocuserInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(FocuserInstruction)}, Text: {Text}";
        }
    }
}